...
- [x] Quick pick shows three options: Apply, Dry Run (Server), Dry Run (Client)
- [x] Each option has a descriptive label and description
- [x] Pressing Escape cancels the operation without executing anything
- [x] Selected mode is passed to kubectl execution step
- [x] Quick pick has appropriate title and placeholder text
