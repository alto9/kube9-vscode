...
import type { PodEvent } from '../../../providers/PodDescribeProvider';

/**
 * Props for EventsTab component.
 */
interface EventsTabProps {
    /** Array of Pod events to display */
    events: PodEvent[];
}
...
/**
 * Events tab component that displays Pod events in a timeline format.
