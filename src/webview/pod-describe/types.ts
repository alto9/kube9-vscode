...
/**
 * Re-export PodDescribeData from PodDescribeProvider for convenience.
 */
import type { PodDescribeData } from '../../providers/PodDescribeProvider';
