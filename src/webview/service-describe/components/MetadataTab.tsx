...
import { ServiceMetadata } from '../../../providers/ServiceDescribeProvider';

/**
 * Props for MetadataTab component.
 */
interface MetadataTabProps {
    /** Service metadata to display */
    metadata: ServiceMetadata;
}

/**
 * Metadata tab component that displays Service labels, annotations, and other metadata.
 */
