...
import type { ServiceEvent } from '../../../providers/ServiceDescribeProvider';

/**
 * Props for EventsTab component.
 */
interface EventsTabProps {
    /** Array of Service events to display */
    events: ServiceEvent[];
}
...
/**
 * Events tab component that displays Service events in a timeline format.
    ...
    if (events.length === 0) {
        return (
            <div className="empty-state">
                <p>No events found for this Service</p>
