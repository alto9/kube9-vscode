...
### Product telemetry and event catalog PRs
...
Point `kubectl` (or `KUBECONFIG`) at the cluster you use; the extension reads whatever kubeconfig the process is given.
